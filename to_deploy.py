...
def graph_qa_natural(question, schema):
    ...
    return answer
try:
    response = graph_qa_natural(
        "compare and contrast number of orders and customers joining by campaign?",
        schema
    )
except:
    response="Unable to process your question, please refine your question and ask again."
